...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    ...
    font_large = ImageFont.truetype('ANNIEMUSIC/assets/annie/ArialReg.ttf', size=120)
    font_small = ImageFont.truetype('ANNIEMUSIC/assets/annie/ArialReg.ttf', size=120)
